...
function MainPage() {
    ...
    return (
        <Box className="MainPage" sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh' }}>
            ...
            <Container maxWidth="lg" sx={{ py: 3 }}>
                <Grid className="grid-modules" container spacing={3} sx={{ justifyContent: 'center', display: 'flex' }}>
                    {modules.map((mod) => (
