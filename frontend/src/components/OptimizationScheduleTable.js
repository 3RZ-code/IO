...
const OptimizationScheduleTable = ({ schedules }) => {
    ...
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                  ...
                  <td className="px-4 py-3 text-center">
                    <span
                      className={`inline-block px-3 py-1 rounded font-semibold text-white ${
                        isTariff ? 'bg-blue-500' : 'bg-orange-500'
                      }`}
                    >
      ...
      <div className="mt-4 p-4 bg-gray-50 rounded-lg text-xs text-gray-600">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li><span className="text-green-600">Z Baterii</span> - energia pochodząca z systemu magazynowania</li>
